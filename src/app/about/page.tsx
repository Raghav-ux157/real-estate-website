...
export default function AboutPage() {
  ...
  return (
    <div className="pt-24 md:pt-28 pb-28 md:pb-20 min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="container mx-auto px-4 md:px-8 max-w-5xl text-center mb-12 md:mb-20">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-semibold mb-3 sm:mb-4 border border-primary/20">
          <Award className="w-3.5 h-3.5" /> Established 2014 • Jaipur, Rajasthan
        </div>
        <h1 className="text-2xl sm:text-4xl md:text-6xl font-heading font-bold mb-4 sm:mb-6 text-foreground tracking-tight">
      ...
      {/* Story & Philosophy */}
      <section className="container mx-auto px-4 md:px-8 max-w-6xl mb-14 md:mb-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
          <div className="relative aspect-[16/10] sm:aspect-[4/5] rounded-2xl md:rounded-3xl overflow-hidden shadow-2xl border border-border">
            <Image 
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-transparent to-transparent flex items-end p-5 sm:p-8">
              <div>
                <p className="font-heading font-bold text-lg sm:text-xl text-white">Boutique Headquarters</p>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="pt-4 sm:pt-6 grid grid-cols-2 gap-4 sm:gap-8 border-t border-border/60">
              <div>
                <h4 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-primary mb-0.5 sm:mb-1">₹500Cr+</h4>
                <p className="text-[10px] sm:text-xs text-muted-foreground font-semibold uppercase tracking-wider">Properties Transacted</p>
              </div>
              <div>
                <h4 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-primary mb-0.5 sm:mb-1">1,200+</h4>
                <p className="text-[10px] sm:text-xs text-muted-foreground font-semibold uppercase tracking-wider">Happy Families</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Core Values */}
      <section className="bg-card/40 py-14 md:py-20 border-y border-border/60 mb-14 md:mb-20">
        <div className="container mx-auto px-4 md:px-8 max-w-6xl">
          <div className="text-center max-w-2xl mx-auto mb-10 md:mb-16">
            <h2 className="text-2xl sm:text-3xl font-heading font-bold mb-2 sm:mb-3">Our Core Commitments</h2>
            <p className="text-muted-foreground text-xs sm:text-sm">Every consultation is guided by 4 uncompromising principles.</p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div key={i} className="p-4 sm:p-6 rounded-2xl bg-secondary/30 border border-border/50 space-y-2 sm:space-y-3">
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-primary/10 text-primary flex items-center justify-center font-bold text-xs sm:text-sm">
                  0{i + 1}
                </div>
                <h3 className="font-heading font-semibold text-base sm:text-lg text-foreground">{pillar.title}</h3>
      ...
      <section className="container mx-auto px-4 text-center max-w-3xl">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold mb-3 sm:mb-4 text-foreground">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          <Button 
            ...
            className="w-full sm:w-auto px-8 h-12 sm:h-13 text-xs sm:text-sm font-semibold rounded-xl"
          >
          ...
          >
            <Button size="lg" variant="outline" className="w-full sm:w-auto px-8 h-12 sm:h-13 text-xs sm:text-sm font-semibold rounded-xl flex items-center justify-center gap-2">
